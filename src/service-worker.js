...
let ignoreRequests = new RegExp(
    '(' +
        [
            '.com/', // customize to your use case, home page https://api.github.com/users
            '/users',
...
*/
            ...
            if (ignoreRequests.test(event.request.url)) {
                ...
                // .then((response) => {
                //     console.log(
                //         'Response from network without catch:',
                //         response
                //     );
                //     return response;
                // })
                // .catch(function (error) {
                //     console.error('Fetching failed no network :', error);
                //     // return caches.match('./sw-test/gallery/myLittleVader.jpg');
                //     throw error;
                // });
            }
            if (response && !navigator.onLine) {
                console.log('No internet connection, serving from cache');
                console.log('Found response in cache:', response);
                return response;
            }
            console.log('As you are Online. About to fetch from network...');
            return fetch(event.request)
                .then((response) => {
